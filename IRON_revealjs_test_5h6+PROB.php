...
<script type="text/javascript">
  ...
  colorNames.forEach(color => {
    ...
    <script src="reveal.js-1.4.0/lib/js/head.min.js"></script>

    <script>
      // Load reveal.js as well as a classList polyfill if needed
      head.js( !document.body.classList ? 'reveal.js-1.4.0/lib/js/classList.js' : null )
        .js( 'reveal.js-1.4.0/js/reveal.js', function() {
...
*/
      ...
      head.js( 'reveal.js-1.4.0/lib/js/highlight.js', function() { 
