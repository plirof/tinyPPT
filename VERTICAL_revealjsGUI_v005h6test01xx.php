...
function addVerticalSlide(slideIndex) {
  ...
  // If the slide doesn't already have vertical slides, initialize an array
  if (!slide.verticalSlides) {
    slide.verticalSlides = [];
  }

  // Push a new vertical slide object
  slide.verticalSlides.push({
...
function updateSlideDisplay() {
  ...
  slides.forEach((slide, index) => {
    ...
    // Check for nested vertical slides
